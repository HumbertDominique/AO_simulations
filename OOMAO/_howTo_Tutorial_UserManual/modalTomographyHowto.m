...
%% Zernike measurement
maxRadialDegree = 8;
zern = zernike(2:zernike.nModeFromRadialOrder(maxRadialDegree),tel.D,'resolution',nPx);%,'pupil',tel.pupil);
zern.lex = false;
% figure(10)
% imagesc(zern.phase)
...
%[Proj Projcell] = analyticalSmallFootprintExpansion(zernWfs,tel,gs,atm)
